...
START_TEST(test_addr_resolv_localhost)
{
    ...
    ck_assert_msg(ip.family == TOX_AF_INET, "Expected family AF_INET, got %u.", ip.family);
    ...
    ck_assert_msg(ip.family == TOX_AF_INET6, "Expected family AF_INET6 (%u), got %u.", TOX_AF_INET6, ip.family);
    ...
    ck_assert_msg(extra.family == TOX_AF_INET, "Expected family AF_INET (%u), got %u.", TOX_AF_INET, extra.family);
